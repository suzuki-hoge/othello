...
function assertEquals(act: any, exp: any, message: string): void {
 ...
 */
function put(b: Board, p: Point, ownStone: Stone): boolean {
 ...
 * 裏返る石があれば置ける
 */
function canPut(b: Board, p: Point, ownStone: Stone): boolean {
 ...
 */
function getReversiblePoints(b: Board, p: Point, ownStone: Stone): Point[] {
